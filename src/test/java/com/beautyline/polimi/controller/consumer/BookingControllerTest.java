...
public class BookingControllerTest {
	...
	public void getBookingDone() {
		...
		// act
		ResponseEntity<BookingDTO> response = restTemplate.exchange("/consumer/booking/111", HttpMethod.GET, request, BookingDTO.class);
	...
	public void getBookingsDone() {
		...
		// act
		ResponseEntity<Page<BookingDTO>> response = restTemplate.exchange("/consumer/booking/list", HttpMethod.GET, request, type);
	...
	public void createDone() throws JsonProcessingException {
		...
		// act
		ResponseEntity<BookingDTO> response = restTemplate.exchange("/consumer/booking/create", HttpMethod.POST, request, BookingDTO.class);
	...
	public void deleteDone() throws JsonProcessingException {
		...
		// act
		ResponseEntity<Void> response = restTemplate.exchange("/consumer/booking/111", HttpMethod.DELETE, request, Void.class);
